...
export class TeachersAddComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.addTeacherForm = this.formBuilder.group({
      TeacherId: ["2323", [Validators.required]],
      Name: ["Sujay", [Validators.required]],
      Gender: ["Male", [Validators.required]],
      DateOfBirth: ["", [Validators.required]],
      TeacherPh: ["8553544568", [Validators.required]],
      DateOfJoining: ["", [Validators.required]],
      Qualification: ["BE", [Validators.required]],
      Experience: ["3Years", [Validators.required]],
      isCTR: ["Yes", [Validators.required]],
      isCTRClass: ["5", [Validators.required]],
      isCTRSection: ["33333", [Validators.required]],
      Location: [""],
      FullAddress: [""],
      State: [""],
      Pin: [""],
